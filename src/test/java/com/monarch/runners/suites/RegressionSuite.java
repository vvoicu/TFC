...
@RunWith(Suite.class)
@Suite.SuiteClasses({ TC001WikiSearchAppleTest.class, TC002ApiReqresGetTest.class, TC003DdtWikiSearchTest.class, TC004CheckEmailTest.class, TC008BddCucumberRunnerTest.class })
